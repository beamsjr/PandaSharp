...
df.Head(12).Viz()
    ...
    .Theme(PandaSharp.Viz.Themes.VizTheme.Dark)
...
File.WriteAllText(Path.Combine(outputDir, "fragment.html"),
    $"<html><head><script src='https://cdn.plot.ly/plotly-2.35.2.min.js'></script></head><body>{fragment}</body></html>");
