...
using TreeVisualizer = Cortex.Viz.Charts.TreeVisualizer;

/*
 * House Prices Prediction using Cortex
 * ==========================================
 ...
 *
 * Uses Cortex for data loading/manipulation and Cortex.ML
...
Console.WriteLine("════════════════════════════════════════════════════════════");
Console.WriteLine("  House Prices Prediction — Cortex");
Console.WriteLine("════════════════════════════════════════════════════════════\n");
...
report
    ...
    .Callout(
        ...
        "In Cortex we encode categoricals explicitly — the model sees the same information.",
        CalloutStyle.Note);
...
report
    ...
    .Callout(
        ...
        "to visualization stayed in Cortex. No pandas, no numpy, no scikit-learn, no matplotlib.",
        CalloutStyle.Success);
