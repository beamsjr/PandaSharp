...
// ============================================================
//  PandaSharp Stock Market Analyzer — Full Dataset
//  Generates two StoryBoard reports:
//    1. Stock Analysis — the data story
//    2. Performance Report — how PandaSharp performed
// ============================================================
...
Console.WriteLine("=== PandaSharp Stock Market Analyzer (Full Dataset) ===\n");
...
Console.Write($"[native={PandaSharp.Native.NativeOps.IsAvailable}] ");
DataFrame withReturns;
if (PandaSharp.Native.NativeOps.IsAvailable &&
...
{
    var returnCol = PandaSharp.Native.NativeOps.EvalDailyReturn(closeForEval, openForEval, "DailyReturn");
...
perf.Add(("Eval (DailyReturn)", evalMs, allStocks.RowCount, $"Native={PandaSharp.Native.NativeOps.IsAvailable}"));
...
var perfStory = StoryBoard.Create("PandaSharp Performance Report")
    .Author("PandaSharp Benchmark")
