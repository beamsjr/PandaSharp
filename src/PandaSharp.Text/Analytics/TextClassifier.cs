...
public class TextClassifier
{
    ...
    /// Always thrown. ONNX text classification requires PandaSharp.ML.Onnx and a compatible
    ...
    public DataFrame Predict(DataFrame df, string textColumn)
    {
        throw new NotImplementedException(
            ...
            "To implement: (1) load the ONNX model via PandaSharp.ML.Onnx.OnnxScorer, " +
