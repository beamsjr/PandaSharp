...
namespace Cortex.ML.MLNet;

/// <summary>
/// Bridge between Cortex DataFrames and ML.NET IDataView.
/// Enables using Cortex for data loading/processing and ML.NET for model training.
/// </summary>
public static class DataViewBridge
{
    /// <summary>
    /// Convert a Cortex DataFrame to an ML.NET IDataView.
    ...
    /// <summary>
    /// Convert an ML.NET IDataView back to a Cortex DataFrame.
...
/// <summary>
/// Custom IDataView implementation that reads directly from Cortex DataFrame columns.
