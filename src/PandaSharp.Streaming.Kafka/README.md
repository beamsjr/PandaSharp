# PandaSharp.Streaming.Kafka

Apache Kafka connector for PandaSharp Streaming — consumer source and producer sink.
...
```bash
dotnet add package PandaSharp.Streaming.Kafka
```
...
using PandaSharp.Streaming.Kafka;
