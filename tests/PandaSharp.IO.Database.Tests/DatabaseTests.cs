...
namespace PandaSharp.IO.Database.Tests;
...
public class DatabaseTests : IDisposable
{
    ...
    public void Generate_ScanOnly_SelectStar()
    {
        ...
        var plan = new PandaSharp.Lazy.ScanPlan(df);
        var gen = new SqlGenerator(new PostgresDialect());
    ...
    public void Generate_Filter_PushesWhereClause()
    {
        ...
        var plan = new PandaSharp.Lazy.FilterPlan(
            new PandaSharp.Lazy.ScanPlan(df),
            Col("age") > Lit(30));
        var gen = new SqlGenerator(new PostgresDialect());
    ...
    {
        var df = new DataFrame(new Column<int>("id", [1]));
        var plan = new PandaSharp.Lazy.SelectPlan(
            new PandaSharp.Lazy.ScanPlan(df),
            ["name", "age"]);
        var gen = new SqlGenerator(new PostgresDialect());
    ...
    {
        var df = new DataFrame(new Column<int>("id", [1]));
        var plan = new PandaSharp.Lazy.SortPlan(
            new PandaSharp.Lazy.ScanPlan(df),
            "salary", false);
        var gen = new SqlGenerator(new PostgresDialect());
    ...
    {
        var df = new DataFrame(new Column<int>("id", [1]));
        var plan = new PandaSharp.Lazy.HeadPlan(
            new PandaSharp.Lazy.ScanPlan(df), 10);
        var gen = new SqlGenerator(new PostgresDialect());
    ...
    public void Generate_Head_SqlServer_UsesTop()
    {
        var df = new DataFrame(new Column<int>("id", [1]));
        var plan = new PandaSharp.Lazy.HeadPlan(
            new PandaSharp.Lazy.ScanPlan(df), 5);
        var gen = new SqlGenerator(new SqlServerDialect());
    ...
    public void Generate_FilterThenSort_CombinesClauses()
    {
        var df = new DataFrame(new Column<int>("id", [1]));
        var plan = new PandaSharp.Lazy.SortPlan(
            new PandaSharp.Lazy.FilterPlan(
                new PandaSharp.Lazy.ScanPlan(df),
                Col("age") > Lit(25)),
            "salary", true);
        var gen = new SqlGenerator(new PostgresDialect());
    ...
    public void Generate_SelectFilterSortHead_FullChain()
    {
        var df = new DataFrame(new Column<int>("id", [1]));
        var plan = new PandaSharp.Lazy.HeadPlan(
            new PandaSharp.Lazy.SortPlan(
                new PandaSharp.Lazy.FilterPlan(
                    new PandaSharp.Lazy.SelectPlan(
                        new PandaSharp.Lazy.ScanPlan(df),
                        ["name", "salary"]),
    ...
    {
        var df = new DataFrame(new Column<int>("id", [1]));
        var plan = new PandaSharp.Lazy.GroupByAggPlan(
            new PandaSharp.Lazy.ScanPlan(df),
            ["department"],
            PandaSharp.GroupBy.AggFunc.Count);
        var gen = new SqlGenerator(new PostgresDialect());
    ...
    {
        var df = new DataFrame(new Column<int>("id", [1]));
        var plan = new PandaSharp.Lazy.WithColumnPlan(
            new PandaSharp.Lazy.ScanPlan(df),
    ...
    public void Generate_ChainedHead_TakesSmallestLimit()
    {
        var df = new DataFrame(new Column<int>("id", [1]));
        var plan = new PandaSharp.Lazy.HeadPlan(
            new PandaSharp.Lazy.HeadPlan(
                new PandaSharp.Lazy.ScanPlan(df), 100),
            10);
        var gen = new SqlGenerator(new PostgresDialect());
    ...
    {
        var scanner = new DatabaseScanner(_conn, "users", new SqliteDialect());
        var df = scanner.LazyJoin("departments", "id", PandaSharp.Joins.JoinType.Inner)
            .Collect();
    ...
    {
        var scanner = new DatabaseScanner(_conn, "users", new SqliteDialect());
        var df = scanner.LazyJoin("departments", "id", PandaSharp.Joins.JoinType.Left)
            .Collect();
    ...
    {
        var leftPlan = new PandaSharp.Lazy.ExternalScanPlan(_ => null!, "db://users");
        var rightPlan = new PandaSharp.Lazy.ExternalScanPlan(_ => null!, "db://departments");
        var joinPlan = new PandaSharp.Lazy.JoinPlan(leftPlan, rightPlan, "id", PandaSharp.Joins.JoinType.Inner);
    ...
    {
        var leftPlan = new PandaSharp.Lazy.ExternalScanPlan(_ => null!, "db://orders");
        var rightPlan = new PandaSharp.Lazy.ExternalScanPlan(_ => null!, "db://customers");
        var joinPlan = new PandaSharp.Lazy.JoinPlan(leftPlan, rightPlan, "customer_id", PandaSharp.Joins.JoinType.Left);
