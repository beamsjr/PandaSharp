...
namespace PandaSharp.Geo.Tests;
...
public class GeoTests
{
    ...
    public void Dissolve_GroupsByKeyAndComputesCentroids()
    {
        ...
        var result = df.Dissolve("lat", "lon", "region", PandaSharp.GroupBy.AggFunc.Sum);
    ...
    public void Dissolve_SumAggregation()
    {
        ...
        var (data, dissolved) = DissolveOps.Dissolve(df, geo, "cat", PandaSharp.GroupBy.AggFunc.Sum);
    ...
    public void Dissolve_CountAggregation()
    {
        ...
        var geo = df.ToGeoColumn("lat", "lon");
        var (data, _) = DissolveOps.Dissolve(df, geo, "region", PandaSharp.GroupBy.AggFunc.Count);
